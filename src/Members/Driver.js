...
import ExpensesTable from "../Home View/ExpensesTable";
  ...
  return (
    <Content>
      ...
      <div className={classes.summaryCards}>
        ...
        <SummaryCard title={"Number of Sales"} />
        <SummaryCard title={"Type of Product"}/>
        <SummaryCard title={"Membership Status"} />
      </div>
      <div className={classes.summaryCards}>
        <SummaryCard title="Last 30 Days" component={<RevenueLine />} />
        <SummaryCard title="Graph description"/>
      </div>
